...
class CCG_SP():
    ...
    def create_model(self):
        ...
        epsilon_pos_100 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="epsilon_pos_100")
        epsilon_neg_100 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="epsilon_neg_100")
        epsilon_pos_50 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="epsilon_pos_50")
        epsilon_neg_50 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="epsilon_neg_50")
        epsilon_pos_20 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="epsilon_pos_20")
        epsilon_neg_20 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="epsilon_neg_20")
        kapa_pos_100 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="kapa_pos_100")
        kapa_neg_100 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="kapa_neg_100")
        kapa_pos_50 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="kapa_pos_50")
        kapa_neg_50 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="kapa_neg_50")
        kapa_pos_20 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="kapa_pos_20")
        kapa_neg_20 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="kapa_neg_20")
        xi_pos_100 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="xi_pos_100")
        xi_neg_100 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="xi_neg_100")
        xi_pos_50 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="xi_pos_50")
        xi_neg_50 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="xi_neg_50")
        xi_pos_20 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="xi_pos_20")
        xi_neg_20 = model.addVars(self.nb_periods, vtype=GRB.BINARY, obj=0, name="xi_neg_20")
        ...
        # alpha_pos/neg
        model.addConstrs((alpha_pos_100[i] >= - self.M * epsilon_pos_100[i] for i in self.t_set), name='c_alpha_pos_100_1')
        model.addConstrs((alpha_pos_100[i] <= self.M * epsilon_pos_100[i] for i in self.t_set), name='c_alpha_pos_100_2')
        model.addConstrs((alpha_pos_100[i] >= phi_PV[i] - self.M * (1 - epsilon_pos_100[i]) for i in self.t_set), name='c_alpha_pos_100_3')
        model.addConstrs((alpha_pos_100[i] <= phi_PV[i] + self.M * (1 - epsilon_pos_100[i]) for i in self.t_set), name='c_alpha_pos_100_4')
        model.addConstrs((alpha_pos_50[i] >= - self.M * epsilon_pos_50[i] for i in self.t_set), name='c_alpha_pos_50_1')
        model.addConstrs((alpha_pos_50[i] <= self.M * epsilon_pos_50[i] for i in self.t_set), name='c_alpha_pos_50_2')
        model.addConstrs((alpha_pos_50[i] >= phi_PV[i] - self.M * (1 - epsilon_pos_50[i]) for i in self.t_set), name='c_alpha_pos_50_3')
        model.addConstrs((alpha_pos_50[i] <= phi_PV[i] + self.M * (1 - epsilon_pos_50[i]) for i in self.t_set), name='c_alpha_pos_50_4')
        model.addConstrs((alpha_pos_20[i] >= - self.M * epsilon_pos_20[i] for i in self.t_set), name='c_alpha_pos_20_1')
        model.addConstrs((alpha_pos_20[i] <= self.M * epsilon_pos_20[i] for i in self.t_set), name='c_alpha_pos_20_2')
        model.addConstrs((alpha_pos_20[i] >= phi_PV[i] - self.M * (1 - epsilon_pos_20[i]) for i in self.t_set), name='c_alpha_pos_20_3')
        model.addConstrs((alpha_pos_20[i] <= phi_PV[i] + self.M * (1 - epsilon_pos_20[i]) for i in self.t_set), name='c_alpha_pos_20_4')

        model.addConstrs((alpha_neg_100[i] >= - self.M * epsilon_neg_100[i] for i in self.t_set), name='c_alpha_neg_100_1')
        model.addConstrs((alpha_neg_100[i] <= self.M * epsilon_neg_100[i] for i in self.t_set), name='c_alpha_neg_100_2')
        model.addConstrs((alpha_neg_100[i] >= phi_PV[i] - self.M * (1 - epsilon_neg_100[i]) for i in self.t_set), name='c_alpha_neg_100_3')
        model.addConstrs((alpha_neg_100[i] <= phi_PV[i] + self.M * (1 - epsilon_neg_100[i]) for i in self.t_set), name='c_alpha_neg_100_4')
        model.addConstrs((alpha_neg_50[i] >= - self.M * epsilon_neg_50[i] for i in self.t_set), name='c_alpha_neg_50_1')
        model.addConstrs((alpha_neg_50[i] <= self.M * epsilon_neg_50[i] for i in self.t_set), name='c_alpha_neg_50_2')
        model.addConstrs((alpha_neg_50[i] >= phi_PV[i] - self.M * (1 - epsilon_neg_50[i]) for i in self.t_set), name='c_alpha_neg_50_3')
        model.addConstrs((alpha_neg_50[i] <= phi_PV[i] + self.M * (1 - epsilon_neg_50[i]) for i in self.t_set), name='c_alpha_neg_50_4')
        model.addConstrs((alpha_neg_20[i] >= - self.M * epsilon_neg_20[i] for i in self.t_set), name='c_alpha_neg_20_1')
        model.addConstrs((alpha_neg_20[i] <= self.M * epsilon_neg_20[i] for i in self.t_set), name='c_alpha_neg_20_2')
        model.addConstrs((alpha_neg_20[i] >= phi_PV[i] - self.M * (1 - epsilon_neg_20[i]) for i in self.t_set), name='c_alpha_neg_20_3')
        model.addConstrs((alpha_neg_20[i] <= phi_PV[i] + self.M * (1 - epsilon_neg_20[i]) for i in self.t_set), name='c_alpha_neg_20_4')

        # beta_pos/neg
        model.addConstrs((beta_pos_100[i] >= - self.M * kapa_pos_100[i] for i in self.t_set), name='c_beta_pos_100_1')
        model.addConstrs((beta_pos_100[i] <= self.M * kapa_pos_100[i] for i in self.t_set), name='c_beta_pos_100_2')
        model.addConstrs((beta_pos_100[i] >= phi_WT[i] - self.M * (1 - kapa_pos_100[i]) for i in self.t_set), name='c_beta_pos_100_3')
        model.addConstrs((beta_pos_100[i] <= phi_WT[i] + self.M * (1 - kapa_pos_100[i]) for i in self.t_set), name='c_beta_pos_100_4')
        model.addConstrs((beta_pos_50[i] >= - self.M * kapa_pos_50[i] for i in self.t_set), name='c_beta_pos_50_1')
        model.addConstrs((beta_pos_50[i] <= self.M * kapa_pos_50[i] for i in self.t_set), name='c_beta_pos_50_2')
        model.addConstrs((beta_pos_50[i] >= phi_WT[i] - self.M * (1 - kapa_pos_50[i]) for i in self.t_set), name='c_beta_pos_50_3')
        model.addConstrs((beta_pos_50[i] <= phi_WT[i] + self.M * (1 - kapa_pos_50[i]) for i in self.t_set), name='c_beta_pos_50_4')
        model.addConstrs((beta_pos_20[i] >= - self.M * kapa_pos_20[i] for i in self.t_set), name='c_beta_pos_20_1')
        model.addConstrs((beta_pos_20[i] <= self.M * kapa_pos_20[i] for i in self.t_set), name='c_beta_pos_20_2')
        model.addConstrs((beta_pos_20[i] >= phi_WT[i] - self.M * (1 - kapa_pos_20[i]) for i in self.t_set), name='c_beta_pos_20_3')
        model.addConstrs((beta_pos_20[i] <= phi_WT[i] + self.M * (1 - kapa_pos_20[i]) for i in self.t_set), name='c_beta_pos_20_4')

        model.addConstrs((beta_neg_100[i] >= - self.M * kapa_neg_100[i] for i in self.t_set), name='c_beta_neg_100_1')
        model.addConstrs((beta_neg_100[i] <= self.M * kapa_neg_100[i] for i in self.t_set), name='c_beta_neg_100_2')
        model.addConstrs((beta_neg_100[i] >= phi_WT[i] - self.M * (1 - kapa_neg_100[i]) for i in self.t_set), name='c_beta_neg_100_3')
        model.addConstrs((beta_neg_100[i] <= phi_WT[i] + self.M * (1 - kapa_neg_100[i]) for i in self.t_set), name='c_beta_neg_100_4')
        model.addConstrs((beta_neg_50[i] >= - self.M * kapa_neg_50[i] for i in self.t_set), name='c_beta_neg_50_1')
        model.addConstrs((beta_neg_50[i] <= self.M * kapa_neg_50[i] for i in self.t_set), name='c_beta_neg_50_2')
        model.addConstrs((beta_neg_50[i] >= phi_WT[i] - self.M * (1 - kapa_neg_50[i]) for i in self.t_set), name='c_beta_neg_50_3')
        model.addConstrs((beta_neg_50[i] <= phi_WT[i] + self.M * (1 - kapa_neg_50[i]) for i in self.t_set), name='c_beta_neg_50_4')
        model.addConstrs((beta_neg_20[i] >= - self.M * kapa_neg_20[i] for i in self.t_set), name='c_beta_neg_20_1')
        model.addConstrs((beta_neg_20[i] <= self.M * kapa_neg_20[i] for i in self.t_set), name='c_beta_neg_20_2')
        model.addConstrs((beta_neg_20[i] >= phi_WT[i] - self.M * (1 - kapa_neg_20[i]) for i in self.t_set), name='c_beta_neg_20_3')
        model.addConstrs((beta_neg_20[i] <= phi_WT[i] + self.M * (1 - kapa_neg_20[i]) for i in self.t_set), name='c_beta_neg_20_4')

        # gamma_pos/neg
        model.addConstrs((gamma_pos_100[i] >= - self.M * xi_pos_100[i] for i in self.t_set), name='c_gamma_pos_100_1')
        model.addConstrs((gamma_pos_100[i] <= self.M * xi_pos_100[i] for i in self.t_set), name='c_gamma_pos_100_2')
        model.addConstrs((gamma_pos_100[i] >= phi_load[i] - self.M * (1 - xi_pos_100[i]) for i in self.t_set), name='c_gamma_pos_100_3')
        model.addConstrs((gamma_pos_100[i] <= phi_load[i] + self.M * (1 - xi_pos_100[i]) for i in self.t_set), name='c_gamma_pos_100_4')
        model.addConstrs((gamma_pos_50[i] >= - self.M * xi_pos_50[i] for i in self.t_set), name='c_gamma_pos_50_1')
        model.addConstrs((gamma_pos_50[i] <= self.M * xi_pos_50[i] for i in self.t_set), name='c_gamma_pos_50_2')
        model.addConstrs((gamma_pos_50[i] >= phi_load[i] - self.M * (1 - xi_pos_50[i]) for i in self.t_set), name='c_gamma_pos_50_3')
        model.addConstrs((gamma_pos_50[i] <= phi_load[i] + self.M * (1 - xi_pos_50[i]) for i in self.t_set), name='c_gamma_pos_50_4')
        model.addConstrs((gamma_pos_20[i] >= - self.M * xi_pos_20[i] for i in self.t_set), name='c_gamma_pos_20_1')
        model.addConstrs((gamma_pos_20[i] <= self.M * xi_pos_20[i] for i in self.t_set), name='c_gamma_pos_20_2')
        model.addConstrs((gamma_pos_20[i] >= phi_load[i] - self.M * (1 - xi_pos_20[i]) for i in self.t_set), name='c_gamma_pos_20_3')
        model.addConstrs((gamma_pos_20[i] <= phi_load[i] + self.M * (1 - xi_pos_20[i]) for i in self.t_set), name='c_gamma_pos_20_4')

        model.addConstrs((gamma_neg_100[i] >= - self.M * xi_neg_100[i] for i in self.t_set), name='c_gamma_neg_100_1')
        model.addConstrs((gamma_neg_100[i] <= self.M * xi_neg_100[i] for i in self.t_set), name='c_gamma_neg_100_2')
        model.addConstrs((gamma_neg_100[i] >= phi_load[i] - self.M * (1 - xi_neg_100[i]) for i in self.t_set), name='c_gamma_neg_100_3')
        model.addConstrs((gamma_neg_100[i] <= phi_load[i] + self.M * (1 - xi_neg_100[i]) for i in self.t_set), name='c_gamma_neg_100_4')
        model.addConstrs((gamma_neg_50[i] >= - self.M * xi_neg_50[i] for i in self.t_set), name='c_gamma_neg_50_1')
        model.addConstrs((gamma_neg_50[i] <= self.M * xi_neg_50[i] for i in self.t_set), name='c_gamma_neg_50_2')
        model.addConstrs((gamma_neg_50[i] >= phi_load[i] - self.M * (1 - xi_neg_50[i]) for i in self.t_set), name='c_gamma_neg_50_3')
        model.addConstrs((gamma_neg_50[i] <= phi_load[i] + self.M * (1 - xi_neg_50[i]) for i in self.t_set), name='c_gamma_neg_50_4')
        model.addConstrs((gamma_neg_20[i] >= - self.M * xi_neg_20[i] for i in self.t_set), name='c_gamma_neg_20_1')
        model.addConstrs((gamma_neg_20[i] <= self.M * xi_neg_20[i] for i in self.t_set), name='c_gamma_neg_20_2')
        model.addConstrs((gamma_neg_20[i] >= phi_load[i] - self.M * (1 - xi_neg_20[i]) for i in self.t_set), name='c_gamma_neg_20_3')
        model.addConstrs((gamma_neg_20[i] <= phi_load[i] + self.M * (1 - xi_neg_20[i]) for i in self.t_set), name='c_gamma_neg_20_4')

        # delta
        model.addConstrs((delta_pos_100[i] >= - self.M * epsilon_pos_100[i] for i in self.t_set), name='c_delta_pos_100_1')
        model.addConstrs((delta_pos_100[i] <= self.M * epsilon_pos_100[i] for i in self.t_set), name='c_delta_pos_100_2')
        model.addConstrs((delta_pos_100[i] >= phi_curt_PV[i] - self.M * (1 - epsilon_pos_100[i]) for i in self.t_set), name='c_delta_pos_100_3')
        model.addConstrs((delta_pos_100[i] <= phi_curt_PV[i] + self.M * (1 - epsilon_pos_100[i]) for i in self.t_set), name='c_delta_pos_100_4')
        model.addConstrs((delta_pos_50[i] >= - self.M * epsilon_pos_50[i] for i in self.t_set), name='c_delta_pos_50_1')
        model.addConstrs((delta_pos_50[i] <= self.M * epsilon_pos_50[i] for i in self.t_set), name='c_delta_pos_50_2')
        model.addConstrs((delta_pos_50[i] >= phi_curt_PV[i] - self.M * (1 - epsilon_pos_50[i]) for i in self.t_set), name='c_delta_pos_50_3')
        model.addConstrs((delta_pos_50[i] <= phi_curt_PV[i] + self.M * (1 - epsilon_pos_50[i]) for i in self.t_set), name='c_delta_pos_50_4')
        model.addConstrs((delta_pos_20[i] >= - self.M * epsilon_pos_20[i] for i in self.t_set), name='c_delta_pos_20_1')
        model.addConstrs((delta_pos_20[i] <= self.M * epsilon_pos_20[i] for i in self.t_set), name='c_delta_pos_20_2')
        model.addConstrs((delta_pos_20[i] >= phi_curt_PV[i] - self.M * (1 - epsilon_pos_20[i]) for i in self.t_set), name='c_delta_pos_20_3')
        model.addConstrs((delta_pos_20[i] <= phi_curt_PV[i] + self.M * (1 - epsilon_pos_20[i]) for i in self.t_set), name='c_delta_pos_20_4')

        model.addConstrs((delta_neg_100[i] >= - self.M * epsilon_neg_100[i] for i in self.t_set), name='c_delta_neg_100_1')
        model.addConstrs((delta_neg_100[i] <= self.M * epsilon_neg_100[i] for i in self.t_set), name='c_delta_neg_100_2')
        model.addConstrs((delta_neg_100[i] >= phi_curt_PV[i] - self.M * (1 - epsilon_neg_100[i]) for i in self.t_set), name='c_delta_neg_100_3')
        model.addConstrs((delta_neg_100[i] <= phi_curt_PV[i] + self.M * (1 - epsilon_neg_100[i]) for i in self.t_set), name='c_delta_neg_100_4')
        model.addConstrs((delta_neg_50[i] >= - self.M * epsilon_neg_50[i] for i in self.t_set), name='c_delta_neg_50_1')
        model.addConstrs((delta_neg_50[i] <= self.M * epsilon_neg_50[i] for i in self.t_set), name='c_delta_neg_50_2')
        model.addConstrs((delta_neg_50[i] >= phi_curt_PV[i] - self.M * (1 - epsilon_neg_50[i]) for i in self.t_set), name='c_delta_neg_50_3')
        model.addConstrs((delta_neg_50[i] <= phi_curt_PV[i] + self.M * (1 - epsilon_neg_50[i]) for i in self.t_set), name='c_delta_neg_50_4')
        model.addConstrs((delta_neg_20[i] >= - self.M * epsilon_neg_20[i] for i in self.t_set), name='c_delta_neg_20_1')
        model.addConstrs((delta_neg_20[i] <= self.M * epsilon_neg_20[i] for i in self.t_set), name='c_delta_neg_20_2')
        model.addConstrs((delta_neg_20[i] >= phi_curt_PV[i] - self.M * (1 - epsilon_neg_20[i]) for i in self.t_set), name='c_delta_neg_20_3')
        model.addConstrs((delta_neg_20[i] <= phi_curt_PV[i] + self.M * (1 - epsilon_neg_20[i]) for i in self.t_set), name='c_delta_neg_20_4')

        # zeta
        model.addConstrs((zeta_pos_100[i] >= - self.M * kapa_pos_100[i] for i in self.t_set), name='c_zeta_pos_100_1')
        model.addConstrs((zeta_pos_100[i] <= self.M * kapa_pos_100[i] for i in self.t_set), name='c_zeta_pos_100_2')
        model.addConstrs((zeta_pos_100[i] >= phi_curt_WT[i] - self.M * (1 - kapa_pos_100[i]) for i in self.t_set), name='c_zeta_pos_100_3')
        model.addConstrs((zeta_pos_100[i] <= phi_curt_WT[i] + self.M * (1 - kapa_pos_100[i]) for i in self.t_set), name='c_zeta_pos_100_4')
        model.addConstrs((zeta_pos_50[i] >= - self.M * kapa_pos_50[i] for i in self.t_set), name='c_zeta_pos_50_1')
        model.addConstrs((zeta_pos_50[i] <= self.M * kapa_pos_50[i] for i in self.t_set), name='c_zeta_pos_50_2')
        model.addConstrs((zeta_pos_50[i] >= phi_curt_WT[i] - self.M * (1 - kapa_pos_50[i]) for i in self.t_set), name='c_zeta_pos_50_3')
        model.addConstrs((zeta_pos_50[i] <= phi_curt_WT[i] + self.M * (1 - kapa_pos_50[i]) for i in self.t_set), name='c_zeta_pos_50_4')
        model.addConstrs((zeta_pos_20[i] >= - self.M * kapa_pos_20[i] for i in self.t_set), name='c_zeta_pos_20_1')
        model.addConstrs((zeta_pos_20[i] <= self.M * kapa_pos_20[i] for i in self.t_set), name='c_zeta_pos_20_2')
        model.addConstrs((zeta_pos_20[i] >= phi_curt_WT[i] - self.M * (1 - kapa_pos_20[i]) for i in self.t_set), name='c_zeta_pos_20_3')
        model.addConstrs((zeta_pos_20[i] <= phi_curt_WT[i] + self.M * (1 - kapa_pos_20[i]) for i in self.t_set), name='c_zeta_pos_20_4')

        model.addConstrs((zeta_neg_100[i] >= - self.M * kapa_neg_100[i] for i in self.t_set), name='c_zeta_neg_100_1')
        model.addConstrs((zeta_neg_100[i] <= self.M * kapa_neg_100[i] for i in self.t_set), name='c_zeta_neg_100_2')
        model.addConstrs((zeta_neg_100[i] >= phi_curt_WT[i] - self.M * (1 - kapa_neg_100[i]) for i in self.t_set), name='c_zeta_neg_100_3')
        model.addConstrs((zeta_neg_100[i] <= phi_curt_WT[i] + self.M * (1 - kapa_neg_100[i]) for i in self.t_set), name='c_zeta_neg_100_4')
        model.addConstrs((zeta_neg_50[i] >= - self.M * kapa_neg_50[i] for i in self.t_set), name='c_zeta_neg_50_1')
        model.addConstrs((zeta_neg_50[i] <= self.M * kapa_neg_50[i] for i in self.t_set), name='c_zeta_neg_50_2')
        model.addConstrs((zeta_neg_50[i] >= phi_curt_WT[i] - self.M * (1 - kapa_neg_50[i]) for i in self.t_set), name='c_zeta_neg_50_3')
        model.addConstrs((zeta_neg_50[i] <= phi_curt_WT[i] + self.M * (1 - kapa_neg_50[i]) for i in self.t_set), name='c_zeta_neg_50_4')
        model.addConstrs((zeta_neg_20[i] >= - self.M * kapa_neg_20[i] for i in self.t_set), name='c_zeta_neg_20_1')
        model.addConstrs((zeta_neg_20[i] <= self.M * kapa_neg_20[i] for i in self.t_set), name='c_zeta_neg_20_2')
        model.addConstrs((zeta_neg_20[i] >= phi_curt_WT[i] - self.M * (1 - kapa_neg_20[i]) for i in self.t_set), name='c_zeta_neg_20_3')
        model.addConstrs((zeta_neg_20[i] <= phi_curt_WT[i] + self.M * (1 - kapa_neg_20[i]) for i in self.t_set), name='c_zeta_neg_20_4')
...
if __name__ == "__main__":
    ...
    dirname = '/Users/Andrew/OneDrive - GIST/Code/Graduation/PC_RGD_CCG_bM_MIU/'
    day = '2018-07-04'
    ...
    DE1_p = read_file(dir='/Users/Andrew/OneDrive - GIST/Code/Graduation/PC_RGD_CCG_bM_MIU/export_MILP/', name='sol_MILP_DE1_p')
    DE1_rp = read_file(dir='/Users/Andrew/OneDrive - GIST/Code/Graduation/PC_RGD_CCG_bM_MIU/export_MILP/', name='sol_MILP_DE1_rp')
    DE1_rn = read_file(dir='/Users/Andrew/OneDrive - GIST/Code/Graduation/PC_RGD_CCG_bM_MIU/export_MILP/', name='sol_MILP_DE1_rn')
    ES_charge = read_file(dir='/Users/Andrew/OneDrive - GIST/Code/Graduation/PC_RGD_CCG_bM_MIU/export_MILP/', name='sol_MILP_ES_charge')
    ES_discharge = read_file(dir='/Users/Andrew/OneDrive - GIST/Code/Graduation/PC_RGD_CCG_bM_MIU/export_MILP/', name='sol_MILP_ES_discharge')
    ES_SOC = read_file(dir='/Users/Andrew/OneDrive - GIST/Code/Graduation/PC_RGD_CCG_bM_MIU/export_MILP/', name='sol_MILP_ES_SOC')
    x_curt_PV = read_file(dir='/Users/Andrew/OneDrive - GIST/Code/Graduation/PC_RGD_CCG_bM_MIU/export_MILP/', name='sol_MILP_x_curt_PV')
    x_curt_WT = read_file(dir='/Users/Andrew/OneDrive - GIST/Code/Graduation/PC_RGD_CCG_bM_MIU/export_MILP/', name='sol_MILP_x_curt_WT')
    ...
    SP_dual = CCG_SP(PV_forecast=PV_forecast, WT_forecast=WT_forecast, load_forecast=load_forecast, PV_pos_100=PV_pos_100, PV_neg_100=PV_neg_100, PV_pos_50=PV_pos_50, PV_neg_50=PV_neg_50, PV_pos_20=PV_pos_20, PV_neg_20=PV_neg_20,
                     ...
                     load_pos_100=load_pos_100, load_neg_100=load_neg_100, load_pos_50=load_pos_100, load_neg_50=load_neg_50, load_pos_20=load_pos_20, load_neg_20=load_neg_20,
